...
export default function InnovationService() {
  return (
      ...
      <main className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          <div className="flex items-center gap-2 text-xs text-zinc-600 dark:text-zinc-400 mb-4">
            ...
            <span>Innovation & Platform Development</span>
          </div>
          <h1 className="text-4xl font-bold mb-4">Innovation & Platform Development</h1>
          <p className="text-zinc-600 dark:text-zinc-400 mb-8">From idea to market-ready platform</p>
